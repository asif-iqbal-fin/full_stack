...
const resolvers = {
  ...
  Mutation:{
    addBook:(root,args) => {
        ...
        authors = (authors.find(author => author.name === args.author)) === undefined ? authors.concat(newAuthor) : authors
...
const bookOfAuthor = (author) => books.filter((book) => book.author === author.name).length
